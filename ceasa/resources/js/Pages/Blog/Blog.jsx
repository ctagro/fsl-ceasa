        ...
        <div className="content-r flex lg:flex-row bg-white lg:w-[90%] lg:mt-[200px] md:w-[80%] md:m-[200px] md:justify-center md:flex-row md:mt-[100px] flex-col justify-center items-center mt-[50px] ">
          ...
          <div className="content-info flex lg:flex-col lg:pl-[70px] md:pl-[20px] md:pr-[20px] lg:pr-[80px] lg:w-[70%] md:w-[70%] flex-col">
            ...
            <p className="content-p lg:text-left md:text-left lg:text-[14px] md:text-[9px] mt-[10px] text-center text-[10px]">
              A micro irrigação é uma técnica de irrigação eficiente e
              sustentável que permite a distribuição controlada de água
              diretamente nas raízes das plantas por meio de pequenos
              gotejadores ou microaspersores. Essa técnica de irrigação é
              especialmente útil em regiões com escassez de água, pois permite
              uma utilização mais racional desse recurso natural. Além disso, a
              micro irrigação também ajuda a reduzir o desperdício de água,
              evitando a irrigação em áreas desnecessárias. Com a micro
              irrigação, é possível fornecer a quantidade adequada de água para
              cada planta, aumentando a produtividade e a <br />
              <a href="#" className="read-more font-semibold underline italic ">
                {" "}
                ...Sabe Mais
              </a>
            </p>
        ...
        <div className="team flex flex-row justify-center items-center">
          <div className="person lg:w-[23%] lg:p-[20px] p-[10px] md:w-[25%]">
            ...
            <p className="person-bio lg:text-[13px] md:text-[9px] text-[6px]">
              A auto-fertilização é o processo em que um organismo se fertiliza
              a si mesmo, sem a necessidade de outro organismo para fornecer o
              material genético.
            </p>
          </div>
          <div className="person lg:w-[23%] lg:p-[20px] p-[10px] md:w-[25%]">
