        ...
        <LandingPage>
            <div>
                <div className=" flex flex-col lg:flex-col justify-center items-center lg:px-4 m-auto max-w-[343px] lg:max-w-[1240px] md:max-w-[820px] ">
                    ...
                    <table className=" flex flex-col  lg:w-[1200px] items-center text-left justify-center ">
                        <thead>
                            <tr className="flex flex-row text-center bg-black text-white p-2 rounded-lg text-sm ">
                                <th className="   "></th>
                                <th className=" lg:w-[130px] md:w-[100px] w-full">
                                    {" "}
                                    Data
                                </th>
                                <th className="lg:w-[250px] md:w-[200px] w-full ">
                                    Produto
                                </th>
                        ...
                        <tbody>
                            <tr className=" flex flex-col bg-white p-2 rounded-lg">
                                ...
                                {priceCeasa.map((priceCeasa) => (
                                    ...
                                    >
                                        <th className=" lg:w-[130px] md:w-[100px]  w-[80px]">
                                            {" "}
                                            {priceCeasa.date}{" "}
                                        </th>
                                        <th className="lg:w-[250px] md:w-[200px]  w-[100px] ">
                                            {" "}
                                            {priceCeasa.product}{" "}
                                        </th>
                                        <th className="lg:w-[150px] md:w-[100px]  w-[40px]">
                                            {" "}
